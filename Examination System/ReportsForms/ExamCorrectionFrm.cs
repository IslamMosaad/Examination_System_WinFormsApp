    ...
    public partial class ExamCorrectionFrm : Form
    {
        ...
        private void btn_getData_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //Exam.LocalReport.ReportPath = "E:\\islam learning prog\\iti journey\\27- Advanced MS SQL server\\project Online Examination System\\Final Project\\Examination System\\Examination System\\Examination System\\Reports\\ExamCorrection.rdlc";
                #region my edit
                //string reportFileName = "ExamCorrection.rdlc";
                //string currentDirectory = Directory.GetCurrentDirectory();
                //string parentDirectory = Directory.GetParent(currentDirectory)?.Parent?.FullName;
                //string parentDirectory2 = Directory.GetParent(parentDirectory).FullName;
                //string reportPath = Path.Combine(parentDirectory2, "Reports", reportFileName);
                //Exam.LocalReport.ReportPath = reportPath;



                string reportFileName = "ExamCorrection.rdlc";
                string reportDirectory = Path.GetFullPath(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..\\..\\..\\Reports"));
